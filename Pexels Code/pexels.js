...
const pexelsUrl4 = 'https://api.pexels.com/v1/search?query=tattoos&page=14&per_page=5';
const pexelsUrl5 = 'https://api.pexels.com/v1/search?query=tattoos&page=4&per_page=5';
